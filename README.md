# waxaments
[![Published on npm](https://img.shields.io/npm/v/@waxam/waxaments.svg?style=flat)](https://www.npmjs.com/package/@waxam/waxaments)
[![Build Status](https://travis-ci.org/waxam/waxaments.svg?branch=master)](https://travis-ci.org/waxam/waxaments)
[![Dependency Status](https://img.shields.io/david/waxam/waxaments.svg?style=flat)](https://david-dm.org/waxam/waxaments)
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/author/waxam)
Welcome to the waxaments project!
WaxaM web components
## Quick-start
...
```bash
$ git clone git@github.com:waxam/waxaments.git
$ cd waxaments
$ yarn install
$ yarn start
```
...
- `$ yarn test`
    -  Run tests on ALL waxaments.
- `$ yarn run build`
    -  Run build on ALL waxaments.
- `$ yarn run storybook`
    - Run storybook
- `$ yarn run build-storybook`
    - Build storybook for deployment
- `$ lerna publish`
    - Publish ALL waxaments' elements to npmjs.com
...
To test all waxaments, run `yarn test` from the root of the repo. If you only want to test the web component you're working on:
...
Then open the URL that will be printed in the terminal. It looks something like this: `http://localhost:8081/components/@@waxam/waxaments/generated-index.html?cli_browser_id=0`.

## Storybook

We've added [Storybook](https://storybook.js.org/) to waxaments as a way to preview our web components as they are being developed. We'll also use Storybook to export a static site that will be the demo site for waxaments.
...
```js
"../../whatwg-fetch/fetch.js": path.join( // this is the third-party dependency in the waxaments
  __dirname,
